...
| **모바일 앱** | Kotlin, XML, React Native (learning) |
| **웹 & 백엔드** | HTML, CSS, JavaScript, React, FastAPI, Oracle |
| **기타** | Git, Docker, AWS, SQLite |     
<br>
...
| 프로젝트 | 설명 | 역할 | GitHub |
|---|---|---|---|
| 🎨 Artmo | 사용자 감정 기반 Text-to-Video & IoT 아트 테라피 | Android 앱/TV 앱 | [Link](https://github.com/kibwa-sosujiki/artimo-emotion-diary-connect) |
| 🗣 Language Ribbon | 사용자 음성 유지 통역 앱 | Android 개발 & ML 모델 연동 | [Link](https://github.com/MJU-Capstone-2023-2/LanguageRibbon-Front) |
| 🏠 SmartHome Chatbot | 스마트홈 IoT 제어 챗봇 서비스 | 웹(React, Matterport) 대시보드 | [Link](https://github.com/orgs/Hanium2023/repositories) |   

<br>

## 🏆 Awards & Certifications
- [2024/12/04] 이브와 ICT 멘토링 공모전 **동상(4등/한국IT여성기업인협회장상)**: Artmo 프로젝트(Android 앱/TV 앱) 
- [2024/10/11] 2024 명지대학교 창의적 SW프로그램 경진대회 **장려상(4등/명지대학교 총장상)**: Language Ribbon(Android & ML)  
- [2023/12/07] 한이음 ICT 멘토링 공모전 **대상(1등/과학기술정보통신부 장관상)**: SmartHome Chatbot(Web)  
- [2023/11/30] WFK IT봉사단 활동 성과 공모전 **대상(1등/한국지능정보사회지능원 원장상)**
- [2023/05/26] 명지대학교 명지CC 창의•융합 아이디어 공모전 **최우수상(2등/명지대학교 총장상)**
